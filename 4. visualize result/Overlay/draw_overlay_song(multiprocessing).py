...
# Setup logging
logging.basicConfig(filename='drawing_overlay_song(multiprocessing).log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')

# Configuration
csv_path = "F:/smoothed_song/"
video_path = "F:/video/overlay_song/"
start_actor_num = 1
end_actor_num = 25
isSong = True
num_processes = 8
