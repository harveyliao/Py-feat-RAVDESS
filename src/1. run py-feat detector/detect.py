...
# Setup logging
logging.basicConfig(filename='run_detector.log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')

# Configuration
RAVDESS_path = "F:/RAVDESS/" # RAVDESS video path
tracked_path = "F:/raw_motion_speech/" # result CSV path
